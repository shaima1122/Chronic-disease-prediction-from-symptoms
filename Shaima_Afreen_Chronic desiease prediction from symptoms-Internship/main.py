...
class DiseasePrediction:
    ...
    def select_model(self):
        if self.model_name == 'mnb':
         return MultinomialNB()
            ...
            return RandomForestClassifier()  # Instantiate Random Forest classifier here
        elif self.model_name == 'knn':
            from sklearn.neighbors import KNeighborsClassifier
            return KNeighborsClassifier()  # Instantiate KNN classifier here
        else:
    ...
    def train_model(self):
        ...
        if self.model_name == 'mnb':
        # Naive Bayes doesn't require feature scaling
            pass
        else:
        # For other models, you can add preprocessing steps or feature scaling here
          pass
        # Training the Model
...
if __name__ == "__main__":
    ...
    dp.train_model()
    test_accuracy, clf_report = dp.make_prediction(saved_model_name=current_model_name)
    print("DT Model Test Accuracy: ", test_accuracy)
    print("Test Data Classification Report: \n", clf_report)

    # Repeat the process for other models (SVM, Random Forest, KNN)
    current_model_name = 'svm'
    dp = DiseasePrediction(model_name=current_model_name)
    dp.train_model()
    test_accuracy, clf_report = dp.make_prediction(saved_model_name=current_model_name)
    print("SVM Model Test Accuracy: ", test_accuracy)
    print("Test Data Classification Report: \n", clf_report)
    ...
    dp.train_model()
    test_accuracy, clf_report = dp.make_prediction(saved_model_name=current_model_name)
    print("RF Model Test Accuracy: ", test_accuracy)
    print("Test Data Classification Report: \n", clf_report)
    ...
    dp.train_model()
    test_accuracy, clf_report = dp.make_prediction(saved_model_name=current_model_name)
    print("Naive Bayes Model Test Accuracy: ", test_accuracy)
    print("Test Data Classification Report: \n", clf_report)'''
...
#print(f'Accuracy of the model: {accuracy * 100:.2f}%')
    ...
    #dp.train_model()
    #test_accuracy, clf_report = dp.make_prediction(saved_model_name=current_model_name)
    #print("KNN Model Test Accuracy: ", test_accuracy)
    #print("Test Data Classification Report: \n", clf_report)